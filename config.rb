...
REGION_LIST.store(4,"eu-west-1")
REGION_LIST.store(5,"sa-east-1")
REGION_LIST.store(6,"us-east-1")
...
INSTANCE_LIST.store(4,"m3.large")
INSTANCE_LIST.store(5,"m3.xlarge")
INSTANCE_LIST.store(6,"m3.2xlarge")
